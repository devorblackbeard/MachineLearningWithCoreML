...
class ImageProcessor{
    ...
    func processRequest(for request:VNRequest, error: Error?){
        ...
        DispatchQueue.main.async {
            let processEnded = Date()
            let elapsedTime = processEnded.timeIntervalSince(self.processStarted)
            print("ImageProcess", #function, "Elapsed time", elapsedTime)
